  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "monday-purple": "var(--monday-purple)",
        "monday-success": "var(--monday-success)",
        "monday-warning": "var(--monday-warning)",
        "monday-error": "var(--monday-error)",
        "monday-bg": "var(--monday-bg)",
        "monday-text": "var(--monday-text)",
        "monday-text-secondary": "var(--monday-text-secondary)",
        "monday-text-muted": "var(--monday-text-muted)",
        "monday-accent": "var(--monday-accent)",
